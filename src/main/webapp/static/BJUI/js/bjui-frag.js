...
+function ($) {
    ...
    window.FRAG = {
        ...
        gridFilter: '<div class="datagrid-filter-box">'
                  ...
                  + '<span class="filter-and"><select data-toggle="selectpicker" data-container="true" data-width="100%"><option value="and">并且</option><option value="or">或者</option></select></span>'  //20160516 显示中文
