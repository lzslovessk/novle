...
+function ($) {
    ...
    Dialog.prototype.open = function() {
      ...
      //dialog 调节插件放大缩小BUG by 马超 2016/8/5
        if(!that.options.resizable){
            $dialog.find('.resizable_h_l,.resizable_h_r,.resizable_h_c,.resizable_c_l,.resizable_c_r,.resizable_f_l,.resizable_f_r,.resizable_f_c').css('cursor',' auto');
        }
    }
