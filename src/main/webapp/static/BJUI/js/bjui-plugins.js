    ...
    $(document).on(BJUI.eventType.initUI, function(e) {
        ...
        $box.find('[data-toggle="moresearch"]').each(function() {
            ...
            $element.click(function(e) {
                ...
                if ($more.is(':visible')) {
                    $element.html('<i class="fa fa-angle-double-down"><span style="padding: 0 3px; font-size: 15px;line-height: 1;position: absolute;margin-top: 3px;">自定义</span></i>')
                    if (name) $('body').data('moresearch.'+ name, false)
                } else {
                    $element.html('<i class="fa fa-angle-double-up"><span style="padding: 0 3px; font-size: 15px;line-height: 1;position: absolute;margin-top: 3px;">自定义</span></i>')
